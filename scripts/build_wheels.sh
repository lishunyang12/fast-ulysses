...
# it installs cleanly and dies on import. scripts/check_wheel.py is what refuses to let that
...
#     pytorch/manylinux2_28-builder:cuda13.0 bash scripts/build_wheels.sh
#
# Environment:
...
for PY in ${PYTHONS}; do
    ...
    mapfile -t excludes < <("${PYBIN}/python" scripts/check_wheel.py --print-excludes)
    ...
    "${PYBIN}/python" scripts/check_wheel.py \
